...
const char* get_string_mes(int mes){
    static const char *strings_mes[] = {
        "ENERO", "FEBRERO", "MARZO", "ABRIL", "MAYO", "JUNIO",
        "JULIO", "AGOSTO", "SEPTIEMBRE", "OCTUBRE", "NOVIEMBRE", "DICIEMBRE"};
    return strings_mes[mes-1];
}

const char* get_string_afirmacion(bool b) {
    static const char *string_afirmacio[] = {"No", "Si"};
    return string_afirmacio[b];
}
